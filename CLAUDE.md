...
7. **Close the cycle (R9):** draft the logbook entry — copy `docs/logbook/TEMPLATE.md` to `docs/logbook/NNNN-<slug>.md`, next number in sequence. A cycle is not done until logged. Fill the failure-location and accounting fields honestly; they are the experiment.
