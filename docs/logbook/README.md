...
The logbook is the data source for the instruments ([rationale](../rationale.md)). Two read from it directly:
...
Entry discipline: small, structured, honest. A perfectly green entry with nothing learned is a valid entry. An entry that hides a failure corrupts the census.
